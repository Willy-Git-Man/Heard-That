  ...
  up: (queryInterface, Sequelize) => {
    ...
    */
      return queryInterface.bulkInsert('Songs', [
        ...
        { userId: 1, albumId: 3, songName: 'Space Disco',artistName: 'T. Schürger', songUrl: "https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3", createdAt: new Date(), updatedAt: new Date(), imageUrl: "https://images-na.ssl-images-amazon.com/images/I/61+xEdXTb-L.jpg"},
